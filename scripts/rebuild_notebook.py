#!/usr/bin/env python3
"""Rebuild colab_comparison.ipynb for unified library + real benchmarks."""
import json
...
cells = [
    ...
    # Cell 1: Install + Clone
    {
        ...
        "source": [
            ...
            "\n",
            "# Test import — unified library (no _v2)\n",
            "from src.models import create_model, create_badger_sota\n",
            "from src.losses import BadgerLoss\n",
            "print('✓ Badger unified library imported')\n",
            "print(f'  Available: create_model (classic), create_badger_sota (SOTA)')"
        ],
        "outputs": [],
    ...
    # Cell 2: Dataset
    {
        ...
        "source": [
            ...
            "print(f'  Classes: {data_info[\"nc\"]}')\n",
            "NUM_CLASSES = data_info['nc']"
        ],
        "outputs": [],
        "execution_count": None
    },
    # Cell 3: Train YOLOv8 Baseline
    {
        "cell_type": "markdown",
        "metadata": {},
        "source": [
    ...
    # Cell 6: Badger training
    {
        ...
        "source": [
            ...
            "        try:\n",
            "            total_loss, loss_dict = loss_fn(cls_scores, bbox_preds, targets,\n",
...
with open("/home/dillun/Desktop/Badger_Ai/notebooks/colab_comparison.ipynb", "w") as f:
    json.dump(notebook, f, indent=1)

print("✓ Notebook rebuilt for unified library + real Colab benchmarks")
print(f"  {len(cells)} cells: install → dataset → YOLOv8 → Badger → speed → scoreboard")
