from .include.rtmdet_hgnetv2 import model, criterion, postprocessor, training_params
...
training_params["output_dir"] = "output/rtmdet_hgnetv2_l_custom"
...
optimizer = L(optim.AdamW)(
    params=L(get_optim_params)(cfg=[{"params": "^(?=.*backbone).*$", "lr": 0.00002}]),
    lr=0.0001,
    betas=[0.9, 0.999],
    weight_decay=0.0001,
)
lr_scheduler = L(optim.lr_scheduler.MultiStepLR)(milestones=[120], gamma=0.1)
