...
from visionhub.models.detection import DenseDetectionPostProcess, RTMDetDetectionCriterion
from visionhub.models.rtmdet import RTMDetDetection
...
criterion = L(RTMDetDetectionCriterion)(
    num_classes=num_classes,
