"""
RTMDet-Pose-S (small) – HGNetV2-B0, 256-ch neck, depth 0.34.
"""
...
# ── Output / training ─────────────────────────────────────────────────────────
training_params["output_dir"] = "output/rtmdetpose_hgnetv2_s_custom"
...
postprocessor.nms_threshold = 0.45  # Lower NMS threshold to reduce overlapping predictions
